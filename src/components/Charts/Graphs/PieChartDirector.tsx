...
export const PieChartDirector = () => {
    ...
    return (<div className="border border-grey-border rounded-md py-4 px-6">
        <p className='font-dmSans font-medium text-xl'>Director Distribution</p>
